...
(def nrg-order [:wind :solar :nuclear :bio :natural-gas :coal :hydro])
...
(def code-savestate-huff
  (let [encoder (createEncoder
                 (str sercom/alphabet "[2160 [[28 4.56 0.12 11 10260 240 _] [12 5.2 0.44 44 16447 142 _] [15 240.8 0.08 12 930 __] [2 0.16 4.63 230 1080 __] [12 482.1 2.82 490 572 __] [30 135.1 28.67 820 1185 __] [1 1 20 100 1d0 _ 500]]]"))]
    (fn [string decode?]
      (if decode?
